...
def get_prompt_template_service(db: DBSession) -> PromptTemplateService:
    """Create PromptTemplateService instance with database session."""
    return PromptTemplateService(db)


PromptTemplateSvc = Annotated[PromptTemplateService, Depends(get_prompt_template_service)]
