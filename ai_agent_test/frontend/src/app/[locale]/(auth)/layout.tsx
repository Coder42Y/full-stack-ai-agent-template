  ...
  return (
    <div className="bg-background text-foreground min-h-screen lg:grid lg:grid-cols-[1.1fr_minmax(0,560px)]">
      ...
      <aside className="hidden p-5 lg:block lg:p-6">
        <div className="theme-light bg-card text-foreground border-foreground/15 relative flex h-full flex-col justify-between overflow-hidden rounded-3xl border p-10 shadow-2xl lg:p-12">
          {/* Background visuals */}
          <div aria-hidden className="pointer-events-none absolute inset-0">
            <div className="bg-grid absolute inset-0 opacity-[0.42]" />
            <div className="bg-brand/[0.16] absolute -top-32 -right-20 h-[460px] w-[460px] rounded-full blur-[120px]" />
            <div className="bg-brand/[0.08] absolute -bottom-20 -left-10 h-[320px] w-[420px] rounded-full blur-[140px]" />
          </div>
