...
export function DataFlowDiagram({ copy = DEFAULT_COPY }: { copy?: DataFlowCopy }) {
    ...
    >
      ...
      <div className="relative grid grid-cols-3 items-center gap-6 md:gap-12">
        <div className="space-y-2.5">
          <p className="eyebrow text-foreground/55 mb-4">{copy.sourcesEyebrow}</p>
