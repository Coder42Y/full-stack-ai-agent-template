...
export default function KBPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl space-y-7">
      <header className="rounded-lg border border-foreground/10 bg-card p-6 sm:p-7">
...
function StatPill({ value, label }: { value: number | string; label: string }) {
  return (
    <div className="rounded-md border border-foreground/10 bg-foreground/[0.02] px-4 py-3">
